...
#
#       The "traditional" style of «sed -e» combined with «${var//search/replace}»
#       is easier to read and write, and less error-prone than using arrays.
#
##############################################################################
...
#
# With -n://services.gradle.org/distributions/gradle-8.2-bin.zip", and non-default
#   * DEFAULT_JVM_OPTS, JAVA_OPTS, and GRADLE_OPTS environment variables.
...
# Use "xargs" to parse quoted args.
#
# With -n, it tells xargs to use at most max-args per command line.
eval "set -- $(
